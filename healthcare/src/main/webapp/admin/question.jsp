...
<%@page import="com.healthcare.common.Util"%>
...
<%
	...
	String nextNavURL = "question.jsp?";
	
	Board board = null;
	Boards boards = boardMgrHelper.getBoards(request, "2");
...
<script type="text/javascript">
	...
	function searchList() {	    
	    document.userList.action='question.jsp';
...
<td width="98%" valign="top" style="padding-left:5">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<tr align="center">            
			...
			<td width='5%' bgcolor="F6F5F5" class="darkgray11" style="padding-bottom:1;padding-top:3"><strong>작성자</strong></td>
		...
		<%	if(boards.getTotRowCnt() < 1) {%>
			<tr align="center">
				<td class="text_c" colspan="3">조회할 자료가 없습니다.</td>
			</tr>
			<tr align="center"> 
		...
		%>
			<tr align="center" onmouseover="javascript:doMouseOverOnTR(this);" onmouseout="javascript:doMouseOutOnTR(this);">
				<td align="center" style="padding-bottom:1;padding-top:3">
					<a href="question_modify.jsp?board_id=<%=board.getBoard_id()%>"><%=board.getBoard_id()%></a>
				</td>
				<td align="center" style="padding-bottom:1;padding-top:3">
					<a href="question_modify.jsp?board_id=<%=board.getBoard_id()%>"><%=board.getTitle()%></a>
				</td>
				<td align="center" style="padding-bottom:1;padding-top:3"><%= Util.notNullValueOf (board.getName(), "") %></td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
 	...
 	<table width="100%" border="0" cellspacing="0" cellpadding="0">     
		<tr>
			<td align="right">
				<a href="question_excel.jsp?totRowCnt=<%=boards.getTotRowCnt()%>"><img src="./images/down.gif"  border="0"></a>
			</td>
		</tr>
	</table>
</td>
