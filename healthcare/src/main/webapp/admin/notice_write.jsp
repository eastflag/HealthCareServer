	      ...
	      <table width="700" border="0" cellspacing="2" cellpadding="1">
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="title" type="text" class="darkgray12" maxlength="60" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
			  </td>
	        </tr>
	        <tr> 
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<textarea name="content" rows="5" class="darkgray12" style="WIDTH: 100%; border:solid 1 #cccccc"></textarea>
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="end_date" type="text" class="darkgray12" maxlength="8" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<textarea name="remark" rows="5" class="darkgray12" style="WIDTH: 100%; border:solid 1 #cccccc" maxlength="60"></textarea>
	          </td>
	        </tr>
	        <tr> 
	          <td height="1" bgcolor="#67AEB8"></td>
...
<!-- 시작 : 버튼 -->
	<table width="700" border="0" cellspacing="0" cellpadding="0">
		<tr> 
			<td align="right" >
				<a href="JavaScript:save(document.docForm, 'notice_write_action.jsp');"><img src="./images/btn_save.gif" border="0"></a>&nbsp;
