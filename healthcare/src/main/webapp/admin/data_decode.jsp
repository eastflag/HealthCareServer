...
<script type="text/javascript">
	...
	function dataDecode(decode_type) { 
		var frm = document.docForm;
		frm.decode_type.value = decode_type;
		frm.action = "data_decode_action.jsp";
		if(confirm("해당 데이터를 복호화 하시겠습니까?")) {
			frm.submit();
		}
	}
</script>
...
<!-- 컨텐츠영역 시작 -->	
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="53" valign="bottom" class="darkgray16b"> Data Decode</td>
        </tr>
		<tr>
	...
	<!-- 시작 : 테이블 -->
	      <table width="700" border="0" cellspacing="2" cellpadding="1">
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<a href="javascript:dataDecode('mdn')">복호화</a>
	          </td>
	        </tr>
	        <tr> 
	          <td height="1" bgcolor="#67AEB8"></td>
