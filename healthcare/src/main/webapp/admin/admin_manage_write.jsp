...
<%
	...
	School school = null;
	Schools schools = schoolMgrHelper.getNotExistAdminSchoolList(request);
...
<script type="text/javascript">
	...
	function duplicationAdminId(){
		...
		if('' == admin_id ||
			...
			var admin_id = document.docForm.admin_id.value;
	...
	<!-- 시작 : 테이블 -->
	      <table width="700" border="0" cellspacing="2" cellpadding="1">
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="admin_id" type="text" class="darkgray12" maxlength="15" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="admin_pass" type="password" class="darkgray12" maxlength="15" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
			  </td>
	        </tr>
	        <tr> 
	          <td height="1" bgcolor="#67AEB8"></td>
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="admin_info" type="text" class="darkgray12" maxlength="60" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" value="-">
			  </td>
	        </tr>
	        <tr> 
	          <td height="1" bgcolor="#67AEB8"></td>
...
<!-- 시작 : 버튼 -->
	<table width="700" border="0" cellspacing="0" cellpadding="0">
		<tr> 
			<td align="right" >
				<a href="JavaScript:save(document.docForm, 'admin_manage_write_action.jsp');"><img src="./images/btn_save.gif" border="0"></a>&nbsp;
