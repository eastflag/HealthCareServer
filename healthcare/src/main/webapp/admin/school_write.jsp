	      ...
	      <table width="700" border="0" cellspacing="2" cellpadding="1">
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="school_name" type="text" class="darkgray12" maxlength="30" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
			  </td>
	        </tr>
	        <tr>
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="address" type="text" class="darkgray12" maxlength="40" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
			  </td>
	        </tr>
	        <tr> 
	          <td height="1" bgcolor="#67AEB8"></td>
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="sido" type="text" class="darkgray12" maxlength="40" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
	        ...
	        <tr> 
	          ...
	          <td style="padding-left:10">
	          	<input name="school_code" type="text" class="darkgray12" maxlength="40" style="WIDTH: 130px; HEIGHT: 19px; border:solid 1 #cccccc" >
...
<!-- 시작 : 버튼 -->
	<table width="700" border="0" cellspacing="0" cellpadding="0">
		<tr> 
			<td align="right" >
				<a href="JavaScript:save(document.docForm, 'school_write_action.jsp');"><img src="./images/btn_save.gif" border="0"></a>&nbsp;
