...
<script type="text/javascript">
	...
	function getSimliVideoList() {
		$.ajax({
			type : "post",
			dataType : "json",
			url : rootPath + "/GetSimliVideoList",
			contentType : 'application/json',
			cache : false,
			data : "{" +
					"\"userId\":\"" + $("#userId").val() + "\"" +	"}",
...
<body>
	...
	<h3>GetSimliVideoList</h3>
	<form name="GetSimliVideoList" method="post">
		<table border="1" class="GridOne">
			<tr>
				<td colspan="2" align="left">HealthCare/GetSimliVideoList <input
					type="button" value="GetSimliVideoList"
					onclick="getSimliVideoList();">
				</td>
			</tr>
			<tr>
				<td>userId</td>
