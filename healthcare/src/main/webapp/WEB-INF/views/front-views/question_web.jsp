	...
	<div class="wrap">
		<div class="header">
			...
			<div class="headerMenu">|
				<a id="smart">스마트건강지킴이</a>&nbsp;|
				<a id="notice">공지사항</a>&nbsp;|
				<a id="qAnda" style="color:red;">Q&#38;A</a>&nbsp;|
			</div>
		</div>
	
		<!-- intro page  -->
		<div class="container pageUI-active" id="page19">
			
			<div class="otherAside">
			<div class="noticeText"><h1 id="noticeText"><span style="color:#0099FF">Q</span> &#38; <span style="color:#0099FF">A</span></h1></div>
				<img class="leaf" src="images/web/leaf.png" alt="나뭇잎">	
				<div class="qAndaView">
					<p>
					이용 중 불편한 사항이나 문의사항 등에 대해서 언제든지 문의 바랍니다.<br>
					이메일 또는 휴대폰 번호를 입력해주시면 해당 연락처로 답변을 드리도록 하겠습니다.	
					</p>
					<form id="dataForm" action="">
						<div class="qa_tbl">
							<table>
								...
								<tbody>
									<tr>
										<td>제목 :</td>
										<td> <input type="text" id="title" name="title" maxlength="60"></td>
										<td>작성자 :</td>
										<td><input type="text" id="name" name="name" maxlength="16"></td>
									</tr>
									<tr>
										<td>이메일주소 :</td>
										<td><input type="text" id="email" name="email" maxlength="26"></td>
										<td>휴대폰번호 :</td>
										<td><input type="text" id="tel" name="tel" maxlength="14"></td>
									</tr>
									<tr>
										<td colspan="4">
											<textarea id="content" name="content" rows="5" cols="40" maxlength="510"></textarea>
										</td>
									</tr>
								</tbody>
							</table>
						...
						<div class="agreement_box">
							...
							-수집하는 개인정보 항목 : 이메일 주소 또는 휴대폰 번호<br>
							-개인정보 수집 방법 : 이용자 문의사항에 대해 이용자가 자발적으로 입력한 개인정보를 수집합니다.<br>
							<br>
							(2) 개인정보 수집 및 이용목적<br>
							- 수집된 개인정보는 문의 사항에 대한 답변 회신 및 이용기록 조회를 위해 활용됩니다.<br>
							<br>
							(3) 개인정보의 보유 및 이용 기간<br>
							- 수집된 이메일 주소, 휴대폰 번호는 관련 법령에 명시되어 있지 않는 한 문의처리 후 1년간 보관합니다.
						</div>
						<div class="agreement_check">
							<label for="check1">동의합니다</label>
							<input type="checkbox" name="check1" id="check1" class="checkbox">
						</div>
						<div class="sendBtn"><h1>문의 보내기</h1></div>
					</form>
				</div>
			</div>
		</div>
...
<script>
	...
	$('.sendBtn').click(function(){
		//alert(convertSerialToJson($("#dataForm").serializeObject ));
		setQuestion();
	});
	...
	function setQuestion(){
		if (i==0) {
			...
			$.ajax({
				...
				//data : convertSerialToJson($("#dataForm")),
	...
	function convertSerialToJson(form){
		var o = {};
