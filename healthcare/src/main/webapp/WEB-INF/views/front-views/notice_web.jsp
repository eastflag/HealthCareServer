	...
	<div class="wrap">
		<div class="header">
			...
			<div class="headerMenu">|
				...
				<a id="notice" style="color:red;">공지사항</a>&nbsp;|
				<a id="qAnda">Q&#38;A</a>&nbsp;|
			</div>
		</div>
		...
		<div class="container pageUI-active" id="page19">
			...
			<div class="noticeText"><h1 id="noticeText"><span style="color:#0099FF">공지</span> 사항</h1></div>
				<img class="leaf" src="images/web/leaf.png" alt="로고">
	...
	function getNotice(jo){
		...
		if(0 == valLen){
			...
			for(var i=0; i < valLen; i++ ){
				...
				pasteTxt+='<dt>'+val[i].title+'<span>'+val[i].reg_date+'</span>'+'</dt>';
		...
		$("#notice_accordion").html(pasteTxt).simpleAccordion();
